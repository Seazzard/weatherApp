    ...
    <section className="five-day">
      {JSON.stringify(weatherFive) === '{}' ? (
        ...
        <>
          ...
          <button className="back" type="button" onClick={() => setDay('one')}>
            Назад
          </button>
              ...
              .map((item) => {
                return (
                  <div className="weather__card" key={item.dt_txt}>
                    <span className="weather__card-time">
                    ...
                    <div className="weather__card-temp">
                      <img
                        ...
                        alt="weather logo"
                      />
                      <span className="weather__card-cel">
                        {Math.trunc(item.main.temp - 273.15)}°C
                      </span>
                    </div>
                    <span className="weather__card-descr">
